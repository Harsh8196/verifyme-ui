...
import PhysicalProduct from '../abi/physicalProduct.json'
                            ...
                            <div id="register-collapse" className="accordion-collapse collapse" aria-labelledby="register-heading" data-bs-parent="#issuerFlush">
                                <div className="accordion-body">
                                    <form className="m-2" style={{ height: '100%' }} onSubmit={claimProduct}>
                                        <div className="mb-3">
                                            <label htmlFor="toAccountInput" className="form-label">Wallet Address</label>
                                            <input id="toAccountInput" aria-describedby="toAccountInputHelp" type='text'
                                                className="form-control"
                                                value={toAccount}
                                                onChange={(event) => setToAccount(event.target.value)}
                                                required
                                            />
                                            <div id="toAccountInputHelp" className="form-text">Your Wallet Address where you want Product's NFT</div>
                                        </div>
                                        <div className="mb-3">
