    ...
    return (
        <Base>
            <div className="HomeContainer">
                ...
                <div className="row mt-3 align-items-center">
                    ...
                    <div>
                        <p>
                            ...
                            We are here to help you out.VerifyMe gives the unique identity of each product using NFTs and verifies its authenticity by scanning QR codes on it.
                ...
                <div className="row mt-3 align-items-center">
                    <h1>Steps to use VerifyMe product</h1>
                    <div>
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">1. Register as a Company (One time registration for one company)</li>
                            <li className="list-group-item">2. VerifyMe verifies KYC and approved your request.Now you become certified company on platform (Any one can approve company request-As per demo purpose)</li>
